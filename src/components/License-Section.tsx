      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-slate-600 max-w-2xl mx-auto">
            Our comprehensive licensing and certifications demonstrate our
            commitment to excellence and compliance in the construction
            industry.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          {licenses.map((license, index) => (
            <TooltipProvider key={index}>
              <Tooltip>
                <TooltipTrigger>
                  <div className="flex flex-col items-center text-center p-4 border border-slate-200 rounded-lg bg-white">
                    <div className="text-slate-900 mb-3">{license.icon}</div>
        ...
        <div className="mt-12 flex items-center justify-center text-sm text-slate-600">
          ...
          <p>
            All licenses and certifications are current and regularly renewed to
            maintain compliance.
          </p>
        </div>
      </div>
